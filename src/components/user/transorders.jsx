...
const Transorder = () => {
  ...
  const data = [
    { key: '1', id: 'HD001', name: 'Sản phẩm A', quantity: 2, major: '200,000 VND', active: 'Đang vận chuyển', customer: 'Nguyễn Văn B', orderDate: '2024-09-25' },
    { key: '2', id: 'HD002', name: 'Sản phẩm B', quantity: 1, major: '150,000 VND', active: 'Đang vận chuyển', customer: 'Trần Thị C', orderDate: '2024-09-24' },
    { key: '3', id: 'HD003', name: 'Sản phẩm C', quantity: 5, major: '500,000 VND', active: 'Đang vận chuyển', customer: 'Lê Quang D', orderDate: '2024-09-23' },
    { key: '4', id: 'HD004', name: 'Sản phẩm D', quantity: 3, major: '300,000 VND', active: 'Đang vận chuyển', customer: 'Phạm Văn E', orderDate: '2024-09-22' },
  ];
