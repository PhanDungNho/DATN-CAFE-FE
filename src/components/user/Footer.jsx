          ...
          <div className="row">
            <div className="col-lg-3 col-md-6">
              <div className="footer-box about-widget">
                ...
                <p>
                  Ở đây, mỗi ly nước là một niềm vui nhỏ, mỗi phút giây là một
                  kỷ niệm đáng nhớ để bạn mang theo.
                </p>
              </div>
            </div>
            <div className="col-lg-3 col-md-6">
            ...
            <div className="col-lg-3 col-md-6">
              <div className="footer-box subscribe">
                ...
                <p>
                  Hãy đăng ký vào danh sách nhận tin của chúng tôi để nhận những
                  cập nhật về sản phẩm mới nhất.
                </p>
