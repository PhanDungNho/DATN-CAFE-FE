...
export const CARTDETAIL_SET = "CARTDETAIL_SET";
export const CARTDETAIL_DELETE = "CARTDETAIL_DELETE";
export const CARTDETAILTOPPING_DELETE = "CARTDETAILTOPPING_DELETE";
export const CARTDETAILS_SET = "CARTDETAILS_SET";
export const CARTDETAILS_FIND = "CARTDETAILS_FIND";
export const CARTDETAIL_STATE_CLEAR = "CARTDETAIL_STATE_CLEAR"
...
export const ADDRESS_STATE_CLEAR = "ADDRESS_STATE_CLEAR";
export const ADDRESS_APPEND = "ADDRESS_APPEND";
export const ADDRESS_UPDATE = "ADDRESS_UPDATE";
export const ADDRESS_UPDATE_ACTIVE = "ADDRESS_UPDATE_ACTIVE";
export const ADDRESS_UPDATE_ISDEFAULT = "ADDRESS_UPDATE_ISDEFAULT";
export const ADDRESSES_FIND = "ADDRESSES_FIND";
